...
public class Application {
    public static void main(String[] args) {
        ...
        *  컴파일시에 미리 타입 검사를 시행하게 되면 클래스나 메소드 내부에서 사용되는 개체의 타입 안정성을
        *  높일 수 있으며, (잘못된 타입인 경우 컴파일 에러를 발생시킴.)
        *  반환값에 대한 타입 변환 및 타입 검사에 들어가는 코드 생략이 가능해진다.
        *  (instance 비교 맟 다운캐스팅 작성 불필요)  
        *  */
        
        /*필기.
        *   제네릭 프로그래밍
        *  데이터의 형식에 의존하지 않고 하나의 값이 여러 다른 데이트 타입들을 가질 수있는 기술에 중점을
        *  두어 재사용성을 높일 수 있는 프로그래밍 방식이다.
        *  */
        ...
        GenericTest<String> gt2 = new GenericTest<>();    // 뒤에 <> 에는 사실 넣지 않아도 된다.
        gt2.setValue(new String("아아아아앙아아아ㅏ아아아아아아아아아아아"));
